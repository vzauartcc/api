...
interface ITrainingSession extends Document, ITimestamps {
	studentCid: number;
...
TrainingSessionSchema.plugin(softDelete.default, {
	deletedAt: true,
});
...
export const TrainingSessionModel = model<ITrainingSession>(
	'TrainingSession',
